import {InfoObject, PathsObject, DefinitionsObject, ResponsesDefinitionsObject,
    SecurityDefinitionsObject, SecurityRequirementObject, TagObject,
    ExternalDocumentationObject, ResponseObject} from './apidoc';
...
export class ApiDefinition {
    ...
    hasDefinition(type: string, toEntityName = false): boolean {
        if (toEntityName) {
